...
var proxyRegexpList    = [
    ...
    '^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?uderzo\.it',
    '^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?udn\.com',
    '^//www\.ukchinese\.com/www/22/2009-03/2842\.html',
    '^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?ukliferadio\.co\.uk',
    '^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?ultravpn\.fr',
    '^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?unblock\.cn\.com',
    '^[\\w\\-]+:\\/+(?!\\/)(?:[^\\/]+\\.)?unholyknight\.com',
...
var proxyWildcardList  = [
    ...
    '*cn.calameo.com*',
    '*canadameet.com*',
    '*//www.cantonese.asia/action-bbs.html*',
    '*.canyu.org*',
    '*.cao.im*',
    '*.caobian.info*',
    '*caochangqing.com*',
